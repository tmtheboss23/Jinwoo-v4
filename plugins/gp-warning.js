...
let handler = async (m, { conn, text, args, groupMetadata, usedPrefix, command }) => {      
        ...
        if (conn.user.jid.includes(who)) return m.reply(`✳️ Mention a user who is not the Bot`)
...
${mssg.wningUser(war)}`, who)
            ...
            m.reply(`♻️ You have been removed from the group *${groupMetadata.subject}* because you were warned *${war}* times`, who)
        }
}
